                              ...
                              >
                                ...
                                >
                                  <tr>
                                    ...
                                    >
                                      <a
                                        href="https://s3.amazonaws.com/unroll-images-production/projects%2F0%2F1634088579725-logo-vip.png"
                                        target="_blank"
                                      >
                                        <img
                                          align="center"
                                          border="0"
                                          src="https://s3.amazonaws.com/unroll-images-production/projects%2F0%2F1634088579725-logo-vip.png"
                                          alt=""
                                          title=""
                                          style="
                                            outline: none;
                                  ...
                                  <p style="font-size: 14px; line-height: 140%">
                                    <span
                                      style="
                                        ...
                                        color: #34495e;
                                      "
                                      >Bạn vừa đăng ký tài khoản Hương Quê thành công. Hương Quê xin dành tặng bạn
                                    voucher giảm 25% cho mọi đơn hàng.
                                  <br />
                                  Mã Voucher : ${voucher}
                                  <br/>
                                  Cảm ơn bạn đã tin tưởng sử dụng dịch vụ của Hương Quê.
                                  </span>
                                  </p>
                                </div>
                              </td>
